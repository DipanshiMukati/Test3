								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" 
											...
											oninput="handleIntegerInput(this, 'quantityError', 12)"
											onblur="validateIntegerInput(this, 'quantityError',12)"
							...
							<div class="col-sm-12">
								...
								<div class="input-group-prepend">
									...
									<input type="text" class="form-control" name="purchasePrice"
										...
										oninput="validateDoubleInput(this, 'purchasePriceError', 4)"
											onblur="validateDoubleInput(this, 'purchasePriceError',4)"
										value="<%=(DataUtility.getStringData(dto.getPurchasePrice()).equals("0") ? "" : dto.getPurchasePrice())%>">
								</div>
							</div>
